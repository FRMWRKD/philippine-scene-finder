    ...
    <div className="relative min-h-[45vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-4">
          <div className="flex items-center gap-1.5 text-white/90 bg-white/15 backdrop-blur-sm px-2.5 py-1 rounded-full border border-white/20">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 mb-6">
          <button 
            ...
            className="bg-white text-coral-600 px-5 py-2.5 rounded-xl font-bold text-base hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl border-2 border-white/20"
          >
            Browse Locations
          </button>
          <button 
            onClick={handleUploadLocation}
            className="bg-gradient-to-r from-coral-500 to-orange-500 text-white px-5 py-2.5 rounded-xl font-bold text-base hover:from-coral-600 hover:to-orange-600 transform hover:scale-105 transition-all duration-300 shadow-xl hover:shadow-2xl border-2 border-white/20"
          >
            List Your Location
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-xl mx-auto">
          ...
          <div className="text-center">
            <div className="text-xl font-bold text-white mb-0.5">50+</div>
