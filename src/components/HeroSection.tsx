    ...
    <div className="relative min-h-[65vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3 md:gap-6 mb-8">
          <div className="flex items-center gap-2 text-white/90 bg-white/15 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button 
            ...
            className="bg-white text-coral-600 px-8 py-4 rounded-2xl font-bold text-lg hover:bg-gray-50 transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-3xl border-2 border-white/20"
          >
            Browse Locations
          </button>
          <button 
            onClick={handleUploadLocation}
            className="bg-gradient-to-r from-coral-500 to-orange-500 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-coral-600 hover:to-orange-600 transform hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-3xl border-2 border-white/20"
          >
            List Your Location
          </button>
        </div>
